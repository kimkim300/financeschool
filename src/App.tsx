...
export default function App() {
  ...
  const handleGoHome = () => {
    ...
    if (confirm('모든 진행 상황이 초기화됩니다. 처음으로 돌아가시겠습니까?')) {
            ...
            >
              ...
              <div className="flex flex-wrap justify-center gap-4 w-full">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={handleGoHome}
                  className="px-12 py-6 bg-gray-900 text-white rounded-3xl text-2xl font-black shadow-2xl hover:bg-black transition-all flex items-center gap-3 border-b-8 border-gray-700"
                >
